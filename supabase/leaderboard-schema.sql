...
alter table public.leaderboard add column if not exists winless_seasons integer;
...
update public.leaderboard set winless_seasons = 0 where winless_seasons is null;
