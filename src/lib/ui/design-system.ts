...
export const BTN = {
  ...
  primaryLg:
    "mode-start-btn btn-press btn-press-glow w-full min-h-[52px] rounded-xl border-2 border-accent-green/75 bg-gradient-to-r from-accent-green to-emerald-400 px-5 py-4 text-center font-display text-lg font-black uppercase tracking-wider text-pitch-950 shadow-[0_0_30px_rgba(34,197,94,0.35)] transition-all hover:from-emerald-400 hover:to-accent-green hover:shadow-[0_0_40px_rgba(34,197,94,0.5)] active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50",
  primaryLgHard:
    "mode-start-btn mode-start-btn-hard btn-press btn-press-glow-hard w-full min-h-[52px] rounded-xl border-2 border-accent-red/85 bg-gradient-to-r from-accent-red to-red-500 px-5 py-4 text-center font-display text-lg font-black uppercase tracking-wider text-white shadow-[0_0_30px_rgba(239,68,68,0.4)] transition-all hover:from-red-500 hover:to-accent-red hover:shadow-[0_0_40px_rgba(239,68,68,0.55)] active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50",
  eraStart:
    "era-start-btn btn-press btn-press-glow-gold flex w-full min-h-[52px] items-center justify-center rounded-xl border-2 border-amber-600/75 bg-gradient-to-r from-accent-gold to-amber-300 px-5 py-4 text-center font-display text-lg font-black uppercase tracking-wider text-pitch-950 shadow-[0_0_30px_rgba(251,191,36,0.35)] transition-all hover:from-amber-300 hover:to-accent-gold hover:shadow-[0_0_40px_rgba(251,191,36,0.5)] active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50",
  eraStartLg:
    "era-start-btn btn-press btn-press-glow-gold flex w-full min-h-[52px] items-center justify-center rounded-xl border-2 border-amber-600/75 bg-gradient-to-r from-accent-gold to-amber-300 px-5 py-4 text-center font-display text-lg font-black uppercase tracking-wider text-pitch-950 shadow-[0_0_30px_rgba(251,191,36,0.35)] transition-all hover:from-amber-300 hover:to-accent-gold hover:shadow-[0_0_40px_rgba(251,191,36,0.5)] active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50",
  eraStartCompact:
    "era-start-btn btn-press btn-press-glow-gold flex w-full min-h-[44px] items-center justify-center rounded-lg border-2 border-amber-600/75 bg-gradient-to-r from-accent-gold to-amber-300 px-4 py-2.5 text-center font-display text-sm font-bold uppercase tracking-wider text-pitch-950 shadow-[0_0_20px_rgba(251,191,36,0.3)] transition-all hover:from-amber-300 hover:to-accent-gold active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50",
  currentStart:
    "mode-start-btn btn-press btn-press-glow flex w-full min-h-[52px] items-center justify-center rounded-xl border-2 border-accent-green/75 bg-gradient-to-r from-accent-green to-emerald-400 px-5 py-4 text-center font-display text-lg font-black uppercase tracking-wider text-pitch-950 shadow-[0_0_30px_rgba(34,197,94,0.35)] transition-all hover:from-emerald-400 hover:to-accent-green hover:shadow-[0_0_40px_rgba(34,197,94,0.5)] active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50",
  currentStartHard:
    "mode-start-btn mode-start-btn-hard btn-press btn-press-glow-hard flex w-full min-h-[52px] items-center justify-center rounded-xl border-2 border-accent-red/85 bg-gradient-to-r from-accent-red to-red-500 px-5 py-4 text-center font-display text-lg font-black uppercase tracking-wider text-white shadow-[0_0_30px_rgba(239,68,68,0.4)] transition-all hover:from-red-500 hover:to-accent-red hover:shadow-[0_0_40px_rgba(239,68,68,0.55)] active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50",
  currentStartCompact:
    "mode-start-btn btn-press btn-press-glow flex w-full min-h-[44px] items-center justify-center rounded-lg border-2 border-accent-green/75 bg-gradient-to-r from-accent-green to-emerald-400 px-4 py-2.5 text-center font-display text-sm font-bold uppercase tracking-wider text-pitch-950 shadow-[0_0_20px_rgba(34,197,94,0.3)] transition-all hover:from-emerald-400 hover:to-accent-green active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50",
  currentStartCompactHard:
    "mode-start-btn mode-start-btn-hard btn-press btn-press-glow-hard flex w-full min-h-[44px] items-center justify-center rounded-lg border-2 border-accent-red/85 bg-gradient-to-r from-accent-red to-red-500 px-4 py-2.5 text-center font-display text-sm font-bold uppercase tracking-wider text-white shadow-[0_0_20px_rgba(239,68,68,0.35)] transition-all hover:from-red-500 hover:to-accent-red active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50",
  secondary:
