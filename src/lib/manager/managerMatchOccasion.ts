  ...
  switch (occasion) {
    ...
    case "wcc":
      return {
        ...
        badgeLabel: "World Club Challenge",
        badgeTone: "sky",
        momentLine: "Northern Hemisphere vs Southern Hemisphere — club world title",
        playCta: "Play World Club Challenge",
        playCtaShort: "Play WCC",
        simulateCta: "Simulate WCC",
        roundStatLabel: "International",
