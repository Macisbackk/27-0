                  ...
                  messages: [
                    {
                      ...
                      body: `${club.name} has submitted an official transfer offer of £${fairFee.toLocaleString()} for ${target.name}. Accept or reject below, or review in Transfers.`,
                      category: "transfer",
                      isRead: false,
                      actionRequired: true,
                      ...
                      actions: [
                        {
                          ...
                          payload: { bidId: bidResult.bid?.id, playerId: target.id },
                        },
                        {
                          label: "Reject Bid",
